...
begin
  ...
  if p_correct then
    ...
    update pokemon_instances set
      hp = least(hp + v_stat_delta, 100),
      attack = least(attack + v_stat_delta, 100),
      defense = least(defense + v_stat_delta, 100),
      speed = least(speed + v_stat_delta, 100),
